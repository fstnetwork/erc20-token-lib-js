...
export default function transferToken(
  ...
  return Promise.all([
    ...
    getETHBalance(limiter, network, apikey, senderAddress),
    gasPriceGweiString !== null
      ? new BN(gasPriceGweiString).toString(16)
      : getEthGasPrice(limiter, network, apikey),
    getNonce(limiter, network, apikey, senderAddress)
    ...
    return sendRawSignedTransaction(limiter, network, apikey, hex);
  });
}
